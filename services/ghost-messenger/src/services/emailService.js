        ...
        <tr>
          <td style="padding:32px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8fafc;border-radius:6px;padding:20px;margin-bottom:24px;">
              ...
              <tr>
                <td style="padding:6px 0;font-size:14px;color:#64748b;"><strong>Doctor</strong></td>
            ...
            <p style="margin:24px 0 0;font-size:12px;color:#94a3b8;text-align:center;">
              Este enlace expira en 2 minutos. Si no confirmas, el cupo pasará al siguiente candidato.
            </p>
          </td>
        </tr>
...
async function sendEmailMessage(to, candidate, slot, confirmLink) {
  if (!process.env.GMAIL_USER || !process.env.GMAIL_PASS) {
    console.warn('GMAIL_USER o GMAIL_PASS no configurados, se omite canal email.');
